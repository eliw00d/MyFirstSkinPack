...
<Document xmlns:i="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://schemas.datacontract.org/2004/07/RelicCore.ModProject">
				...
				<d2p1:anyType i:type="Folder">
					<Children>
						<d2p1:anyType i:type="BurnAttributes">
							<RelativeName>MyFirstSkinPack.xml</RelativeName>
						</d2p1:anyType>
					</Children>
		...
		<d2p1:anyType i:type="TableOfContents">
			...
			<Children>
				<d2p1:anyType i:type="BurnModInfo">
					<Dependencies />
					<Description>My First Skin Pack</Description>
					<Hidden>false</Hidden>
					<Name>My First Skin Pack</Name>
				</d2p1:anyType>
			</Children>
			<IsExpanded>true</IsExpanded>
		</d2p1:anyType>
	...
	<Guid>e27e7885-25e1-4034-9b77-21bfc3da3b09</Guid>
